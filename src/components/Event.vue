    ...
    <div class="row">
      ...
      <div class="col-md-8 offset-md-2" id="event-wrapper">
        ...
        <div id="rsvp-button-wrapper" :v-show="event.submitRsvp">
          <button type="button" class="btn btn-publish2 is-active" @click="toggleState"
        ...
        <div class="details-wrapper event-section snt-comment-widget" >
          <div class="container">
            ...
            <div class="row">
              <div class="col-md-12">
                <a class="snt-submit-comment btn btn-xs btn-primary" @click="event.addComment()">Submit</a>
              </div>
            </div>
